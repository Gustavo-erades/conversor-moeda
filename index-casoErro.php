<?php
    ...
    $cotacao_dolar=$dados_dolar["values"][0]["cotacaoCompra"];
    //euro
    ...
    $cotacao_euro=$dados_euro["values"][0]["cotacaoCompra"];
    //libra
    ...
    $cotacao_libra=$dados_libra["values"][0]["cotacaoCompra"];
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
                    ...
                    <table class="table table-striped table-dark">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><label for="dolar" target="_blank" data-toggle="tooltip" data-placement="right" title="currículo Lattes"><?php print $cotacao_dolar?></label></td>
                            </tr>
                            <tr>
                                <th scope="row"><input type="radio" name="moeda" id="euro" value="euro"></th>
                                <td><label for="euro">Euro</label></td>
                                <td><label for="euro"><?php print $cotacao_euro ?></label></td>
                            </tr>
                            <tr>
                                <th scope="row"><input type="radio" name="moeda"  id="libra" value="libra"></th>
                                <td><label for="libra">Libra</label></td>
                                <td><label for="libra"><?php print $cotacao_libra ?></label></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
